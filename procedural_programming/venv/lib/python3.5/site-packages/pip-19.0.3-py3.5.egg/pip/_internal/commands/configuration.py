...
class ConfigurationCommand(Command):
    ...
    def run(self, options, args):
        ...
        #    Depends on whether the command.py is modifying.
        try:
    ...
    def _get_n_args(self, args, example, n):
        """Helper to make sure the command.py got the right number of arguments
        """
        if len(args) != n:
            msg = (
    ...
    def _save_configuration(self):
        # We successfully ran a modifying command.py. Need to save the
        # configuration.
        try:
