...
class Command(object):
    ...
    def main(self, args):
        ...
        # TODO: Try to get these passing down from the command.py?
        ...
        try:
            ...
            allow_version_check = (
                # Does this command.py have the index_group options?
                hasattr(options, "no_index") and
                # Is this command.py allowed to perform this check?
...
class RequirementCommand(Command):
    ...
    def _build_package_finder(
        ...
        # type: (...) -> PackageFinder
        """
        Create a package finder appropriate to this requirement command.py.
        """
